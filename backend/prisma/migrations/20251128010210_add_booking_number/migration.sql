...
INSERT INTO "new_Booking" ("bookingNumber", "cabinId", "checkIn", "checkOut", "createdAt", "id", "status", "totalPrice", "updatedAt", "userId") SELECT 'RES-' || printf('%06d', cast(random() % 1000000 as integer)), "cabinId", "checkIn", "checkOut", "createdAt", "id", "status", "totalPrice", "updatedAt", "userId" FROM "Booking";
DROP TABLE "Booking";
